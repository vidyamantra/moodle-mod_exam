...
/**
 * Español - México strings for exam module
 * @package   mod
 * @subpackage exam
...
$string['modulename_help'] = 'El módulo de EXAMEN le permite a los usuarios tomar exámenes de preguntas de opción múltiple basados en exámenes seleccionados . 

Aviso sobre Seguridad:
Este módulo contiene código JavaScript en el navegador. Técnicamente es posible que los estudiantes manipulen sus calificaciones del EXAMEN si sben los parámetros correctos. Use con precaución.';
$string['modulenameplural'] = 'EXÁMENES';
$string['noquiz'] = 'No hay Examen para el EXAMEN.';